...
<html>
    <head>
        ...
        <script src="admin/scripts/tinymce/tinymce.min.js"></script>
        <script src="admin/scripts/tinymce/plugins/moxiemanager/js/moxman.loader.min.js"></script>
        <script src="admin/scripts/tinymce/tinyConfig.min.js"></script>
    </head>
                    ...
                    <div class="row bg-primary">
                        ...
                        <div class="col-xl-4 d-flex align-items-center justify-content-end py-1 bg-secondary">
                            <h6 class="text-right text-light m-1">
                                Welcome <?php echo $_SESSION['adminusername']; ?>; <a href="admin/scripts/logout" class="text-light"><wbr>
