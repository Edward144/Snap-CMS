<?php
    ...
    elseif($_POST['method'] == 'saveContent') {
		...
		$update->bind_param('sssssssissssii', $formData['title'], $formData['shortDesc'], $formData['content'], $url, $carouselData, $formData['author'], $formData['datePosted'], $_SESSION['adminid'], $formData['metaTitle'], $formData['metaDescription'], $formData['metaKeywords'], $formData['metaAuthor'], $formData['id'], $formData['postTypeId']);
		$ex = $update->execute();
